...
public class MainFrame extends JFrame {
    ...
    private List<ActionEntry> actionEntries() {
        ...
        return List.of(
                ...
                new ActionEntry("Save As…", "Shift Cmd S", controller::saveCurrentAs),
                new ActionEntry("Save All", "", controller::saveAll),
                new ActionEntry("Print…", "Cmd P", controller::printCurrent),
                new ActionEntry("Reload from Disk", "", controller::reloadFromDisk),
                new ActionEntry("Rename…", "", controller::renameCurrentFile),
                new ActionEntry("Move to Trash", "", controller::deleteCurrentFile),
                ...
                new ActionEntry("Duplicate Line", "Cmd D", controller::duplicateLine),
                new ActionEntry("Delete Line", "Shift Cmd K", controller::deleteLine),
                new ActionEntry("Move Line Up", "Opt Up", controller::moveLineUp),
                new ActionEntry("Move Line Down", "Opt Down", controller::moveLineDown),
                new ActionEntry("Join Lines", "Cmd J", controller::joinLines),
                new ActionEntry("Sort Lines Ascending", "", controller::sortLinesAscending),
                new ActionEntry("Sort Lines Descending", "", controller::sortLinesDescending),
                new ActionEntry("Remove Duplicate Lines", "", controller::removeDuplicateLines),
                new ActionEntry("Trim Trailing Whitespace", "", controller::trimTrailingWhitespace),
                new ActionEntry("UPPERCASE", "", controller::transformUpper),
                new ActionEntry("lowercase", "", controller::transformLower),
                ...
                new ActionEntry("Go to Line…", "Cmd L", controller::goToLine),
                new ActionEntry("Go to Matching Bracket", "Cmd B", controller::goToMatchingBracket),
                new ActionEntry("Clear Marks", "", controller::clearMarks),
